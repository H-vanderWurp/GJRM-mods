...
stopCluster(cl)
cl <- makeCluster(3)
parSapply(cl, Ligen[1:3], function(Liga) {source("Fitting Functions/Fitting GJRM equal.R"); exe.cop.equal(Liga, Cop = "FGM")})
stopCluster(cl)
#cl <- makeCluster(7)
...
source("Fitting Functions/Fitting xgboost_both.R")
