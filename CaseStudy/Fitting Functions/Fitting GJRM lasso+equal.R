## Fitting Cop, equal+lasso penalty

## year. Starting in 2015.

exe.cop.lasso.equal <- function(Liga, Cop, s.year = 2015){
  require(EUfootball)
  Dat <- Matches
  ...
  Res <- list(ResAIC = ResAIC, ResBIC = ResBIC, 
              ...
              errors = errorcount)
  save(file = paste0("Results/cop_lasso+equal/Res_", Liga, s.year, "_", Cop, ".rData"), Res)
}
