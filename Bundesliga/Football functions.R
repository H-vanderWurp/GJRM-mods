...
##hv: 12.10.2020: Error found. Whenever multiple outcomes had a positve expected value,
##hv: only the one bet (with positive expected value > tau) was taken, that has the highest bookmaker odd.
##hv: Thats a variance maximising strategy and not a good idea. The highest expected value should be used.

tipico.cor <- function(GamePred, tau.bet = 1, kelly = FALSE, trueresult){
