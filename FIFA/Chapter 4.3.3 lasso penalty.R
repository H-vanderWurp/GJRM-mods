...
res1 <- parLapply(cl = cl, X = Coplist[1:9], fun = myfun.pen2, dat = dat.n)
res1 <- do.call(rbind, res1)
res2 <- parLapply(cl = cl, X = Coplist[c(10:17)], fun = myfun.pen2, dat = dat.n)
res2 <- do.call(rbind, res2)
#res2 <- res2[c(1,2,3,4,6,7,9,10),]
